...
export default class extends page {
    ...
    async getHtml() {
        ...
        <div class="main-1">
            ...
            <p class="main1-text">Ao se cadastrar, vai receber as últimas atualizações da plataforma.</p>
            ...
            <div class="footer-sideR">
                <div class="sideR-container">
                    ...
                    <div class="sideR-right-middle">
                        <a href="https://ingate.com.br/terms"><span>Termos de serviço</span></a>
                        <a href="https://ingate.com.br/policy"><span>Política de privacidade</span></a>
                    </div>
                    <div class="sideR-right-foot">
                        <span>Created with ❤️ at 🇯🇵 & 🇧🇷</span>
                    </div>
                </div>
            </div>
        </div>
